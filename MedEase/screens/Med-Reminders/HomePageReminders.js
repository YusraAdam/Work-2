...
const HomePageReminders = () => {
  ...
  const dynamicPaddingTop = deviceHeight * 0.24;
  const dynamicWidth = deviceWidth * 0.97;
  ...
  useEffect(() => {
    ...
    // Use setTimeout to navigate to the next screen after 4 seconds
      ...
      <Animated.Text
        ...
        <TouchableOpacity activeOpacity={0.4}>
          <Animated.Image
            ...
            contentFit="cover"
            source={require("../../assets/push-notificationsrafiki-1.png")}
          />
        </TouchableOpacity>
      </LinearGradient>
  );
