...
const HomePagePharmacy = () => {
  ...
  useEffect(() => {
    ...
    // Use setTimeout to navigate to the next screen after 15 seconds
    const timer = setTimeout(() => {
      navigation.navigate("PharmacyHomepage");
    }, 2000);
  ...
  return (
    ...
    <Animated.Text
      ...
      <View style={styles.topBar} />
        ...
        contentFit="cover"
        source={require("../../assets/pharmacistrafiki-11.png")}
      />
        </TouchableOpacity>
